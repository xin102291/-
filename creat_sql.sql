...
('T225652152', '尤婕蓉', 21, '女', '0912345678', '屏東縣屏東市', '心臟病', '010101000011001000110010001101010011011000110101001100100011000100110101000000000000000101000000001111110000000000000001000111101011111100000000000000010000100110010000');
...
('T225652152', '維他命C', '500mg 每日一次', '2024-07-01', '2024-12-31');
...
('T225652152', '2024-08-07', '年度體檢', '血壓: 115/75 mmHg, 心率: 80 bpm, 血糖: 5.5 mmol/L, BMI: 22.4, 肝功能(ALT): 30 U/L, 血紅蛋白: 13.8 g/dL, 血小板計數: 240 x 10^9/L, 整體評估: 正常');
...
('T225652152', '2025-08-07', '14:30:00', '陳醫生', '內科');
...
('T225652152', '定期進行年度體檢，以便及早發現潛在健康問題', '2024-08-07');
...
('T225652152', '2024-08-07', '患者定期健康檢查，未發現健康異常', 'D001', '陳醫生', 'H001', '台北醫院');
